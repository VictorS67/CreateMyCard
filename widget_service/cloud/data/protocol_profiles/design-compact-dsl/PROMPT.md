...
| 角色 | Hex | 用途 |
| --- | --- | --- |
| 品牌蓝 | `#FF0A59F7` | 主要行动墨色或必要的品牌强调；token名称 `font_emphasize` |
| 品牌浅底 | `#190A59F7` | 小面积轻强调表面；token名称 `font_emphasize_10`，为品牌蓝的10%透明度版本 |
...
### BluetoothDeviceOverview（蓝牙耳机）

- 动作区域（按钮）必须使用 `#190A59F7` 作为 backgroundColor
- 严禁使用 `#FFFFFFFF`（白色）或其他背景色
- `#190A59F7` 是品牌蓝 `#FF0A59F7` 的 10% 透明度版本，提供轻量视觉强调
