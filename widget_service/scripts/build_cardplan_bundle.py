...
def main() -> int:
    ...
    if args.check:
        drifted = [
            path for path, text in outputs.items() if not path.is_file() or path.read_text() != text
        ]
        if drifted:
